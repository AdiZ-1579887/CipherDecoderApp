...
{
    public readonly string Atbash = "The Atbash Cipher is like the monoalphabetic cipher, where the key is \"zyxw...\" - the ciphertext alphabet is the reverse of the plaintext alphabet.";
    public readonly string Reverse = "The Reverse Cipher is one of the simplest ciphers - it simply reverses your text!";
